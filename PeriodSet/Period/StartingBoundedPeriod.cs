...
namespace PeriodSet.Period
{
    ...
    /// </summary>
    public class StartingBoundedPeriod : SingleBoundaryInterval<BoundedPeriodSetBuilder, BoundedPeriodSet, BoundedPeriodListBuilder, IBoundedPeriod, DateTime>, IBoundedPeriod
    {
        /// <inheritdoc />

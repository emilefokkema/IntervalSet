...
namespace PeriodSet.Period
{
    ...
    /// </summary>
    public class EndingBoundedPeriod : SingleBoundaryInterval<BoundedPeriodSet, BoundedPeriodListBuilder, IStartingBoundedPeriod, IBoundedPeriod, DateTime>, IBoundedPeriod
    {
        /// <summary>

...
namespace PeriodSet.Period.Boundaries.Kind
{
    ...
    {
        /// <summary>
        /// The <see cref="PeriodSet.Period.Boundaries.Kind.Inclusivity"/> of this kind
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="BoundaryKind"/> with a given <see cref="BoundaryDirection"/> and <see cref="PeriodSet.Period.Boundaries.Kind.Inclusivity"/>
        /// </summary>

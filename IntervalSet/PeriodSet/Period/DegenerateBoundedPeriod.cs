...
namespace IntervalSet.PeriodSet.Period
{
    ...
    /// </summary>
    public class DegenerateBoundedPeriod : SingleBoundedPeriod<BoundedPeriodSet, BoundedPeriodListBuilder, StartingBoundedPeriod, IBoundedPeriod>, IBoundedPeriod
    {
        /// <summary>

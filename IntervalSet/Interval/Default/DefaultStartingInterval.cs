...
namespace IntervalSet.Interval.Default
{
    ...
    public class DefaultStartingInterval<TIntervalBuilder, T> : SingleBoundaryInterval<DefaultSetBuilder<TIntervalBuilder, T>, DefaultIntervalSet<TIntervalBuilder,T>, TIntervalBuilder, IDefaultInterval<T>, T>, IDefaultInterval<T>
